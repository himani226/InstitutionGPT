...
AGENT_REGISTRY: dict[str, AgentConfig] = {
    "admissions": AgentConfig(
        ...
        fallback_contact = "admissions@mindsprout.edu.in | +91-97777-88888",
    ),
    "academics": AgentConfig(
        ...
        fallback_contact = "academics@mindsprout.edu.in | +91-97777-88888",
    ),
    "student": AgentConfig(
        ...
        fallback_contact = "welfare@mindsprout.edu.in | Dr Priya Menon, Room 203 | +91-97777-88888",
    ),
    "faculty": AgentConfig(
        name             = "Faculty Agent",
        ...
        fallback_contact = "hr@minsprout.edu.in",
    ),
    "admin": AgentConfig(
        name             = "Admin Agent",
        agent_filter     = "admin",
        ...
        fallback_contact = "registrar@mindsprout.edu.in | ithelpdesk@mindsprout.edu.in",
    ),
}
